    ...
    content: (
      <>
        <p>
          ...
          (النقاط الثلاث علي يمين أو شِمال → "إضافة للشاشة الرئيسية" أو "تثبيت") 
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        ...
        <ul className="list-disc list-inside">
          <li><strong>الرصيد</strong> عبارة عن رقم وهمي يُعبر عن كمية الأموال المملوكة في اليد , يمكنك تعديلة بالنقر علىه مرتين</li>
          <li><strong>إضافة عنصر:</strong> الحقول: الاسم (مطلوب)، السعر (مطلوب)، صوت (اختياري).</li>
          <li><strong>تعديل سعر داخل القائمة:</strong> اضغط مرتين على السعر لتعديله دون فتح نافذة جديدة.</li>
          <li><strong>حذف:</strong> اضغط مطولًا  على العنصر للحذف بعد تأكيد بسيط.</li>
        </ul>
      </>
    ),
  },
